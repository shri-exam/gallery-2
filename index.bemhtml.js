  ...
  var cache,
        ...
        if (__t === "attrs") {
            ...
            if (__t === "b-page") {
                ...
                if (this.elem === "core") {
                    {
                        "";
                        var __r57 = __this._mode;
                        __this._mode = "";
                        var __r58 = __this.ctx;
                        __this.ctx = {
                            block: "b-page",
                            elem: "js",
                            url: "http://yandex.st/jquery/1.9.1/jquery.min.js"
                        };
                        apply.call(__this);
                        __this._mode = __r57;
                        __this.ctx = __r58;
            ...
            if (this.block === "i-ua") {
                if (!!this.elem === false) {
                    ...
                    return $138.call(this);
                }
            } else {
                return $138.call(this);
            }
        } else if (__t === "jsAttr" || __t === "js") {
            return undefined;
            return;
        } else if (__t === "mix") {
            if (this.block === "b-page") {
    ...
    function $79() {
        ...
        if (_$12ie === true) {
            ...
            {
                "";
                var __r70 = this._mode;
                this._mode = "";
                var __r71 = this.ctx, __r72 = __r71._ieCommented;
                __r71._ieCommented = true;
                var __r73 = this.ctx;
                this.ctx = [ "<!--[if " + _$12hideRule[0] + "]>", _$12hideRule[1], this.ctx, _$12hideRule[2], "<![endif]-->" ];
                apply.call(__this);
                this._mode = __r70;
                __r71._ieCommented = __r72;
                this.ctx = __r73;
                "";
            }
            undefined;
    ...
    function $84() {
        if (!(this["__$anflg"] !== 813378337) === false) {
            if (!!this.elem === false) {
                return $87.call(this);
            } else {
                return $143.call(this);
    ...
    function $87() {
        var __this = this;
        var __r59, __r60, __r61, __r62;
        var _$mctx = this.ctx, _$mdtype = ("", __r59 = this._mode, this._mode = "doctype", __r60 = apply.call(__this), this._mode = __r59, "", __r60), _$mxUA = ("", __r61 = this._mode, this._mode = "xUACompatible", __r62 = apply.call(__this), this._mode = __r61, "", __r62), _$mbuf = [ _$mdtype, {
            elem: "root",
            content: [ {
                elem: "head",
                content: [ {
        ...
        {
            "";
            var __r63 = this["__$anflg"];
            this["__$anflg"] = 813378337;
            {
                "";
                var __r64 = this.ctx;
                this.ctx = _$mbuf;
                var __r65 = this._mode;
                this._mode = "";
                apply.call(__this);
                this.ctx = __r64;
                this._mode = __r65;
